...
aws cloudformation create-stack --stack-name headless-job-$(date "+%Y%m%d%H%M%S") --template-body file://CFN_stacks/job-stack.yaml --parameters file://CFN_stacks/stack-config.json